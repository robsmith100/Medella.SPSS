...
namespace SpssCommon.VariableModel
{
    ...
    ///     http://www.ibm.com/support/knowledgecenter/SSLVMB_27.0.0/com.ibm.spss.statistics.help/syn_variables_variable_formats.htm
    /// </summary>
    ...
    public static class SpssExtensions
    {
        public static bool IsNumber(this FormatType format) =>
            new[] {  FormatType.F, FormatType.COMMA, FormatType.DOT, FormatType.E, FormatType.DOLLAR, FormatType.CCA, FormatType.CCB, FormatType.CCC, FormatType.CCD, FormatType.CCE }.Contains(format);
